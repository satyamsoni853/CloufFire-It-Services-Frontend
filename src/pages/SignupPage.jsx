...
const SignupPage = () => {
  ...
  return (
    <div
      className="min-h-screen flex flex-col items-center py-12 px-4 relative overflow-hidden bg-cover bg-center bg-no-repeat"
    ...
    >
      ...
      <Link
        to="/"
        className="relative z-10 mb-6 transition-transform hover:scale-105"
      >
        <img
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-3">
            <label className="block text-sm font-bold text-gray-700 ml-1 font-sans">
              Choose your role *
            </label>
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                >
                  ...
                  <span
                    className={`font-bold text-[10px] uppercase tracking-tight ${formData.role === role.id ? "text-[#ff7301]" : "text-gray-700"}`}
                  >
                    {role.label}
                  </span>
                </button>
          ...
          <div className="space-y-4">
            ...
            <div className="relative group">
              ...
              />
              <span className="absolute right-5 top-1/2 -translate-y-1/2 text-gray-300 group-focus-within:text-[#ff7301] transition-colors text-sm font-bold pr-1">
                +91
              </span>
            </div>
        ...
        <p className="text-center mt-8 text-gray-500 text-sm font-sans">
          ...
          <Link
            to="/login"
            className="text-[#ff7301] font-bold hover:underline"
          >
            Log in
          </Link>
        </p>
      ...
      <Link
        to="/"
        className="mt-8 text-gray-400 hover:text-gray-600 transition-colors text-sm font-medium relative z-10 font-sans"
      >
        ← Return to Homepage
      </Link>
    </div>
