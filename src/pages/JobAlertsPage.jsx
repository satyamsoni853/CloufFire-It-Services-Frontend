...
const JobAlertsPage = () => {
  ...
  if (loading)
    return <GlobalLoader message="Loading Cloudfire job alerts..." />;
    ...
    <div className="space-y-8 mx-auto">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <button
          ...
          className="bg-[#ff7301] text-white px-8 py-4 rounded-xl font-bold text-sm shadow-xl shadow-orange-100 hover:bg-orange-600 transition-all flex items-center gap-2 active:scale-95 cursor-pointer"
        >
                  ...
                  <div className="flex gap-6">
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-y-3 gap-x-6 text-sm text-gray-400 font-bold uppercase tracking-widest">
                        ...
                        <span className="flex items-center gap-2 text-[#ff7301]">
                          <Mail size={14} /> {alert.frequency}
                        </span>
                      </div>
                    </div>
                  </div>
          ...
          {alerts.length === 0 && (
            <div className="bg-white p-20 rounded-xl border border-dashed border-gray-200 text-center">
              ...
              <p className="text-gray-400 font-medium max-w-sm mx-auto mb-8">
                Set up personalized job alerts to stay ahead of the competition.
              </p>
              <button
                onClick={() => setShowCreateModal(true)}
                className="text-[#ff7301] font-black uppercase tracking-[0.2em] text-xs hover:underline cursor-pointer"
              >
          ...
          >
            <div className="p-10 border-b border-gray-50 bg-gradient-to-br from-gray-900 to-black text-white">
              ...
              <p className="text-gray-400 text-sm mt-2 font-medium">
                Personalize your notification criteria
              </p>
            </div>
            <form onSubmit={handleCreateAlert} className="p-10 space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <InputGroup
                  ...
                  onChange={(v) => setNewAlert({ ...newAlert, keyword: v })}
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="w-full bg-gray-50 border-2 border-transparent focus:border-[#ff7301] focus:bg-white rounded-xl px-6 py-4 outline-none transition-all font-bold text-sm"
                >
              ...
              <div className="flex gap-6">
                  ...
                  <div className="flex gap-2">
                    {["Daily", "Weekly"].map((f) => (
                      <button
                        ...
                        type="button"
                        onClick={() =>
                          setNewAlert({ ...newAlert, frequency: f })
                        }
                ...
                <InputGroup
                  ...
                  onChange={(v) => setNewAlert({ ...newAlert, min_salary: v })}
                  placeholder="e.g. 80k"
                />
              </div>
              ...
              <div className="pt-6 flex gap-4">
                <button
                  ...
                  className="flex-1 py-4 text-gray-500 font-bold text-sm hover:bg-gray-50 rounded-xl transition-all"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  className="flex-[2] bg-[#ff7301] text-white py-4 rounded-xl font-bold shadow-xl shadow-orange-100 hover:bg-orange-600 transition-all active:scale-95"
                >
                  Create Alert
                </button>
              </div>
...
const InputGroup = ({ label, icon, value, onChange, placeholder }) => (
  <div className="space-y-2 flex-1">
    ...
    <div className="relative group">
      <div className="absolute left-5 top-1/2 -translate-y-1/2 text-gray-300 group-focus-within:text-[#ff7301] transition-colors">
        {icon}
      </div>
      <input
        type="text"
        ...
        className="w-full bg-gray-50 border-2 border-transparent focus:border-[#ff7301] focus:bg-white rounded-xl pl-12 pr-6 py-4 outline-none transition-all font-bold text-sm placeholder:text-gray-300"
      />
    </div>
  </div>
);
