...
const HireTalentDashboard = () => {
  ...
  return (
    ...
    >
      ...
      <section className="Welcome relative  rounded-xl border border-gray-100 bg-white ">
        <div className="Welcome relative z-10 flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
          <div className="max-w-2xl">
            ...
            >
              Your career progress is looking great. Check your latest updates
          ...
          >
            <Link
              to="/dashboard/jobs"
              className="group flex items-center justify-center gap-2 rounded-xl bg-[#ff7301] px-5 py-3 text-sm font-semibold text-white transition-all hover:shadow-lg hover:shadow-orange-200 active:scale-95"
            >
              <Briefcase size={16} />
            ...
            <Link
              ...
              className="flex items-center justify-center gap-2 rounded-xl border border-gray-200 bg-gray-50 px-5 py-3 text-sm font-semibold text-gray-700 transition-all hover:bg-gray-100 active:scale-95"
            >
              <Edit3 size={16} />
        ...
        {metrics.map((metric, index) => {
          ...
          return (
            <motion.div
              ...
              className="group relative overflow-hidden rounded-xl border border-gray-100 bg-white p-3 sm:p-5 shadow-sm transition-all hover:shadow-md"
            >
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="mt-1 sm:mt-2 text-lg sm:text-2xl font-semibold tracking-tight text-gray-900">
                    {metric.value}
                  </p>
                </div>
                <div className="rounded-xl bg-gray-50 p-3 text-gray-400 group-hover:text-[#ff7301] transition-colors">
                  <Icon size={20} />
                </div>
              </div>
            </motion.div>
      ...
      <div className="grid grid-cols-1 gap-8 xl:grid-cols-3">
        ...
        <motion.div
          ...
          className="rounded-xl bg-white p-8 border border-gray-100 shadow-sm xl:col-span-2"
        >
        ...
        <motion.div
          ...
          className="rounded-xl bg-gray-50 p-8 border border-gray-100"
        >
          <div className="flex items-start justify-between">
            ...
            <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-white text-lg font-semibold text-[#ff7301] shadow-sm">
              {completeness}%
            </div>
          </div>
          ...
          <div className="mt-8 space-y-3">
            {completionTasks.map((task) => (
              <Link
                key={task.title}
                to={task.href}
                className="group flex items-center gap-4 rounded-xl bg-white p-4 transition-all hover:shadow-md border border-transparent hover:border-gray-100"
              >
                <div
                  className={`rounded-xl p-2 ${task.done ? "text-emerald-500 bg-emerald-50" : "text-gray-400 bg-gray-50"}`}
                >
                  {task.done ? (
      ...
      <div className="grid grid-cols-1 gap-8 xl:grid-cols-3">
        ...
        >
          <div className="mb-8 flex items-center justify-between">
            <div>
              ...
              <p className="text-xs font-medium text-gray-500">
                Top roles matching your expertise.
              </p>
            </div>
            <Link
              to="/dashboard/jobs"
            ...
            {(stats?.recommended_jobs || []).length > 0 ? (
              stats.recommended_jobs.map((job) => (
                <Link
                  key={job.id}
                  to="/dashboard/jobs"
                  className="group block rounded-xl border border-gray-50 bg-gray-50/50 p-6 transition-all hover:bg-white hover:shadow-md hover:border-gray-100"
                >
              ...
              <div className="flex h-32 flex-col items-center justify-center rounded-xl bg-gray-50/50 border border-dashed border-gray-200 lg:col-span-2">
                <p className="text-[11px] font-medium text-gray-400">
                  Complete your profile for job matches.
                </p>
              </div>
            )}
          </div>
        ...
        {/* Quick Links */}
        <div className="grid grid-cols-2 gap-2 sm:gap-4 lg:flex lg:flex-col lg:gap-4">
          <QuickTile
            icon={Bell}
            label="Notifications"
      ...
      <section className="Welcome rounded-xl border border-gray-100 bg-white px-5 py-6 shadow-sm sm:px-7 sm:py-8 lg:px-9">
        <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <Link
            to="/dashboard/profile"
            className="inline-flex items-center justify-center rounded-xl bg-gray-900 px-5 py-2.5 text-xs font-semibold text-white transition-all hover:bg-black active:scale-95"
          >
            Update Profile
          </Link>
        </div>
        <div className="grid grid-cols-2 gap-2 sm:gap-4 lg:grid-cols-3">
          {profileItems.map((item) => (
            <div
              key={item.label}
              className="rounded-xl border border-transparent bg-gray-50 p-3 sm:p-5 transition-all hover:border-gray-100 hover:bg-white hover:shadow-sm"
            >
...
const QuickTile = ({ icon: Icon, label, value, href }) => (
  <Link
    to={href}
    className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 rounded-xl bg-white p-3 sm:p-5 border border-gray-100 shadow-sm transition-all hover:shadow-md hover:border-gray-200"
  >
    <div className="rounded-xl bg-gray-50 p-3 text-gray-400">
      <Icon size={18} />
    </div>
    <div className="min-w-0 flex-1">
      <p className="text-[10px] font-semibold uppercase tracking-widest text-gray-400">
...
const PremiumListPanel = ({ title, icon: Icon, color, children }) => (
  <div className="flex flex-col rounded-xl bg-white p-10 shadow-xl ring-1 ring-gray-100">
...
const EmptyState = ({ text }) => (
  <div className="flex flex-col items-center justify-center rounded-xl bg-gray-50/50 border border-dashed border-gray-200 py-12 text-center">
