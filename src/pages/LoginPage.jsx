...
const LoginPage = () => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-gradient-to-r from-[#ff7301] to-[#ff9845] hover:from-[#e66700] hover:to-[#ff8524] text-white font-bold py-4 rounded-2xl transition-all shadow-xl shadow-[#ff7301]/30 active:scale-[0.98] disabled:opacity-70 mt-2 text-lg font-sans"
          >
            {loading ? "Logging in..." : "Login"}
          </button>
        </form>

        <div className="mt-10 pt-8 border-t border-gray-50 text-center font-sans">
      ...
      <Link
        to="/"
        className="mt-10 text-gray-400 hover:text-gray-600 transition-colors text-sm font-medium relative z-10 font-sans"
      >
        ← Return to Homepage
      </Link>
    </div>
