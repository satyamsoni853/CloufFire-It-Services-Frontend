          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">
                {takingTest.category} Assessment
              </p>
            </div>
          </div>
          <div className="flex items-center gap-6">
            ...
            {testStep !== 2 && (
              <button
                ...
                className="text-gray-400 hover:text-red-500 font-bold text-sm px-4 py-2 rounded-xl hover:bg-red-50 transition-all"
              >
                Quit Test
              </button>
            )}
        ...
        <div className="flex-1 overflow-y-auto bg-gray-50/50 flex justify-center p-6 md:p-12">
          <div className="max-w-3xl w-full">
            {testStep === 0 && (
              ...
              >
                <div className="w-24 h-24 bg-orange-50 rounded-[32px] flex items-center justify-center text-4xl mx-auto mb-8 shadow-inner">
                  🎯
                </div>
                ...
                <p className="text-gray-500 font-medium mb-10 leading-relaxed">
                  This assessment consists of {takingTest.questions}{" "}
                  multiple-choice questions. You have {takingTest.time} to
                  complete it. Once started, the timer cannot be paused.
                </p>
                ...
                <button
                  ...
                  className="w-full bg-[#ff7301] text-white py-5 rounded-[24px] font-bold text-lg shadow-xl shadow-orange-100 hover:bg-orange-600 transition-all active:scale-95"
                >
              ...
              >
                ...
                <div className="bg-white p-10 md:p-14 rounded-[40px] shadow-2xl border border-gray-100">
                  <h3 className="text-2xl font-bold text-gray-900 mb-10 leading-snug">
                    Which of the following is used in React to manage side
                    effects like API calls or subscriptions?
                  </h3>
                  ...
                  <div className="flex justify-between mt-12">
                    <button className="px-8 py-4 text-gray-400 font-bold hover:bg-gray-50 rounded-xl transition-all">
                      Previous
                    </button>
                    <button
                      onClick={submitTest}
            ...
            {testStep === 2 && (
              <motion.div
                ...
                className="bg-white p-12 rounded-[40px] shadow-2xl border border-gray-100 text-center"
              >
                <div className="w-24 h-24 bg-green-50 rounded-[32px] flex items-center justify-center text-4xl mx-auto mb-8 shadow-inner">
                  🏆
                </div>
                <h1 className="text-3xl font-bold text-gray-900 mb-2 font-serif">
                  Assessment Completed!
                </h1>
                <p className="text-green-600 font-bold uppercase tracking-widest text-[10px] mb-8">
                  Verified Candidate Badge Earned
                </p>

                <div className="flex justify-center gap-10 mb-12">
                  <div>
                    <p className="text-4xl font-bold text-gray-900">
                      {score}/{takingTest.questions}
                    </p>
                ...
                <div className="bg-gray-50 p-6 rounded-xl mb-10 text-sm text-gray-600 font-medium">
                  ✨ This result has been automatically added to your profile as
                  a "Verified Skill" to attract premium employers.
                </div>

                <button
                  onClick={() => setTakingTest(null)}
                  className="w-full bg-black text-white py-5 rounded-[24px] font-bold text-lg hover:bg-gray-800 transition-all active:scale-95"
                >
                  Back to Dashboard
                </button>
              </motion.div>
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-500 font-medium">
            Verify your expertise and stand out with verification badges.
          </p>
        </div>
        <div className="bg-orange-50 px-6 py-3 rounded-xl border border-orange-100 flex items-center gap-3">
          <Award className="text-[#ff7301]" size={20} />
          <span className="text-sm font-bold text-[#ff7301]">
            3 Badges Earned
          </span>
        </div>
      </div>
          ...
          >
            ...
            {activeTab === tab && (
              <motion.div
                ...
                className="absolute bottom-[-1px] left-0 right-0 h-0.5 bg-[#ff7301]"
              />
            )}
          </button>
        ))}
        ...
        {ASSESSMENTS.map((test) => (
          ...
          >
            <div className="p-8 flex-1">
              <div className="w-14 h-14 bg-gray-50 rounded-xl flex items-center justify-center text-2xl mb-6 shadow-inner group-hover:bg-[#ff7301]/5 group-hover:scale-110 transition-all duration-500">
                {test.icon}
              </div>
            ...
            <div className="p-4 bg-gray-50 border-t border-gray-100">
              <button
                ...
                className="w-full bg-white border border-gray-200 text-gray-900 font-bold py-4 rounded-xl flex items-center justify-center gap-2 hover:bg-[#ff7301] hover:text-white hover:border-[#ff7301] transition-all shadow-sm active:scale-95 group/btn cursor-pointer"
              >
                Take Assessment{" "}
                <ArrowRight
                  size={16}
...
const Option = ({ label, text, active }) => (
  <button
    className={`w-full flex items-center gap-6 p-6 rounded-[24px] border-2 transition-all group ${active ? "border-[#ff7301] bg-[#ff7301]/5" : "border-gray-50 hover:border-gray-100 hover:bg-gray-50"}`}
  >
    <div
      className={`w-10 h-10 rounded-xl flex items-center justify-center font-bold text-sm transition-all ${active ? "bg-[#ff7301] text-white" : "bg-gray-100 text-gray-500 group-hover:bg-white"}`}
    >
      {label}
    </div>
    <span
      className={`text-base font-bold ${active ? "text-gray-900" : "text-gray-600"}`}
    >
      {text}
    </span>
  </button>
